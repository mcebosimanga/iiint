...
<html lang="en">
  <head>
    ...
    <title>TUT Project | Gym 2024</title>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../sign-in/index.html" tabindex="-1" aria-disabled="false">Log in</a>
          </li>
        </ul>
        <form class="d-flex">
  ...
  <div class="container marketing">
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
        ...
        <img src="../images/pexels-pixabay-221247.jpg" alt="Girl in a jacket" style="width:500px;height:600px;">
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
        <!--<svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#eee"/><text x="50%" y="50%" fill="#aaa" dy=".3em">500x500</text></svg>-->
        <img src="../images/pexels-william-choquette-1954524.jpg" alt="Girl in a jacket" style="width:500px;height:600px;">
      </div>
    </div>
